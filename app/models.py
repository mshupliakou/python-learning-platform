...
class Quiz(db.Model):
    ...
    id_lesson = db.Column(db.Integer, db.ForeignKey('pylearn.lessons.id_lesson'))
...
class Question(db.Model):
    ...
    id_quiz = db.Column(db.Integer, db.ForeignKey('pylearn.quiz.id_quiz'))
...
class Answer(db.Model):
    ...
    id_question = db.Column(db.Integer, db.ForeignKey('pylearn.question.id_question'))
